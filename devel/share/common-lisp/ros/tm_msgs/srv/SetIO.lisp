...
(cl:defmethod fun-val ((m <SetIO-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tm_msgs-srv:fun-val is deprecated.  Use tm_msgs-srv:fun instead.")
  (fun m))

(cl:ensure-generic-function 'ch-val :lambda-list '(m))
(cl:defmethod ch-val ((m <SetIO-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tm_msgs-srv:ch-val is deprecated.  Use tm_msgs-srv:ch instead.")
  (ch m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SetIO-request>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'ch)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    )
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SetIO-request>) istream)
  "Deserializes a message object of type '<SetIO-request>"
    ...
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'ch) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetIO-request>)))
  ...
  "dd90dc6f465eb8532180f93ce5e1fa2e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetIO-request)))
  "Returns md5sum for a message object of type 'SetIO-request"
  "dd90dc6f465eb8532180f93ce5e1fa2e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetIO-request>)))
  ...
  (cl:format cl:nil "int8 FUN_SET_MB_DIGITAL_OUT = 1~%int8 FUN_SET_MB_ANALOG_OUT = 2~%int8 FUN_SET_EE_DIGITAL_OUT = 3~%int8 FUN_SET_EE_ANALOG_OUT = 4~%int8 fun~%int8 ch~%float32 value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetIO-request)))
  "Returns full string definition for message of type 'SetIO-request"
  (cl:format cl:nil "int8 FUN_SET_MB_DIGITAL_OUT = 1~%int8 FUN_SET_MB_ANALOG_OUT = 2~%int8 FUN_SET_EE_DIGITAL_OUT = 3~%int8 FUN_SET_EE_ANALOG_OUT = 4~%int8 fun~%int8 ch~%float32 value~%~%~%"))
...
(cl:defmethod success-val ((m <SetIO-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tm_msgs-srv:success-val is deprecated.  Use tm_msgs-srv:success instead.")
  (success m))
